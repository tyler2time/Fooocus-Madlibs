...
class MadLibsWildcardApp:
    ...
    def build_ui(self):
        ...
        self.randomize_check = tk.Checkbutton(self.root, text="Auto-fill with random wildcard values", variable=self.randomize_var)
        self.randomize_check.pack()
    ...
    def setup_placeholders(self, content):
        ...
        for ph in ordered_placeholders:
            ...
            if self.randomize_var.get() and matching_wildcards:
